...
class HistoryArchiver:
    ...
    def __init__(self, api_key: str, model: str = "claude-3-sonnet-20240229", archive_length: int = 100,
...
class EntityExtractor:
    ...
    def __init__(self, api_key: str, model: str = "claude-3-sonnet-20240229", prompt: str = PROMPT_EN):
        self.api_key = api_key
        self.model = model
